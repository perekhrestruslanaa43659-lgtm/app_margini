...
import { CalendarDays, LayoutDashboard, BookOpen, Calculator, Home, Menu, X, ShieldCheck, FlaskConical, LogOut, Building2, FileText, Send } from 'lucide-react'
...
const nav = [
  ...
  { href: '/proposte-inviate', label: 'Proposte Inviate', icon: Send },
